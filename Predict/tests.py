...
class PredictTests(TestCase):
    ...
    def setUp(self):
        self.test_project = projects.objects.create(
            project_image_path='../static/Predict/1.png', project_alt='Test Project', project_title='Test Project', project_description='Test Project Description', project_link='/home/predict_landmarks/')
    ...
    def test_project_model(self):
        ...
        self.assertEqual(project.project_image_path, '../static/Predict/1.png')
